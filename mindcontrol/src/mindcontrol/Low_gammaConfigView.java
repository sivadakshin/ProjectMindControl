 ...
 * @author siva
 */
public class Low_gammaConfigView extends javax.swing.JFrame {

    /**
     * Creates new form MeditationConfigView
     */
    public Low_gammaConfigView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Low_gamma Command Configuration");

        jLabel2.setText("Enter the Threshold value of Low_gamma: ");
...
//of obj is null remove creating object in getconfig. just make setvisible()
     ...
     */
     public void getConfig(Low_gammaCommand obj){
         this.obj=obj;
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Low_gammaConfigView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
