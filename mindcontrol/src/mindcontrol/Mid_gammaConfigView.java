 ...
 * @author siva
 */
public class Mid_gammaConfigView extends javax.swing.JFrame {

    /**
     * Creates new form MeditationConfigView
     */
    public Mid_gammaConfigView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mid_gamma Command Configuration");

        jLabel2.setText("Enter the Threshold value of Mid_gamma: ");
...
//of obj is null remove creating object in getconfig. just make setvisible()
     ...
     */
     public void getConfig(Mid_gammaCommand obj){
         this.obj=obj;
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mid_gammaConfigView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
