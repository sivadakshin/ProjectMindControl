 ...
 * @author siva
 */
public class Low_alphaConfigView extends javax.swing.JFrame {

    /**
     * Creates new form MeditationConfigView
     */
    public Low_alphaConfigView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Low_alpha Command Configuration");

        jLabel2.setText("Enter the Threshold value of Low_alpha: ");
...
//of obj is null remove creating object in getconfig. just make setvisible()
     ...
     */
     public void getConfig(Low_alphaCommand obj){
         this.obj=obj;
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Low_alphaConfigView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
