 ...
 * @author siva
 */
public class High_alphaConfigView extends javax.swing.JFrame {

    /**
     * Creates new form MeditationConfigView
     */
    public High_alphaConfigView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("High_alpha Command Configuration");

        jLabel2.setText("Enter the Threshold value of High_alpha: ");
...
//of obj is null remove creating object in getconfig. just make setvisible()
     ...
     */
     public void getConfig(High_alphaCommand obj){
         this.obj=obj;
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(High_alphaConfigView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
