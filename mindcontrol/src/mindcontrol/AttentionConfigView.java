 ...
 * @author siva
 */
public class AttentionConfigView extends javax.swing.JFrame {

    /**
     * Creates new form MeditationConfigView
     */
    public AttentionConfigView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Enter the time in seconds for which the user has to attention: ");
        ...
        jLabel1.setText("Attention Command Configuration");

        jLabel2.setText("Enter the Threshold value of attention ");
...
//of obj is null remove creating object in getconfig. just make setvisible()
     ...
     */
     public void getConfig(AttentionCommand obj){
         this.obj=obj;
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AttentionConfigView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
