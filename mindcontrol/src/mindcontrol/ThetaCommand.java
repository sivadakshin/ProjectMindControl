 ...
 * @author siva
 */
public class ThetaCommand implements Command {
...
ThetaCommand(){
   ...
   return flag;
    ...
    public void setCmdconfig() {
        new ThetaConfigView().getConfig(this);
    }
    ...
    public void run(Trigger current) {
        ...
        while(!flag){
            try {
                theta=EegMachine.theta;
                //count clock if theta is detected and clock not running
                if(operation.equals("greater than (>)") && theta > Integer.parseInt(threshold)){detectflag=true;}
                else if(operation.equals("lesser than (<)") && theta < Integer.parseInt(threshold)){detectflag=true;}
                else if(operation.equals("equals (=)") && theta == Integer.parseInt(threshold)){detectflag=true;} 
