 ...
 * @author siva
 */
public class DeltaCommand implements Command {
...
DeltaCommand(){
   ...
   return flag;
    ...
    public void setCmdconfig() {
        new DeltaConfigView().getConfig(this);
    }
    ...
    public void run(Trigger current) {
        ...
        while(!flag){
            try {
                delta=EegMachine.delta;
                //count clock if delta is detected and clock not running
                if(operation.equals("greater than (>)") && delta > Integer.parseInt(threshold)){detectflag=true;}
                else if(operation.equals("lesser than (<)") && delta < Integer.parseInt(threshold)){detectflag=true;}
                else if(operation.equals("equals (=)") && delta == Integer.parseInt(threshold)){detectflag=true;} 
