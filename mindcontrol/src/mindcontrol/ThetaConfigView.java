 ...
 * @author siva
 */
public class ThetaConfigView extends javax.swing.JFrame {

    /**
     * Creates new form MeditationConfigView
     */
    public ThetaConfigView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Theta Command Configuration");

        jLabel2.setText("Enter the Threshold value of Theta: ");
...
//of obj is null remove creating object in getconfig. just make setvisible()
     ...
     */
     public void getConfig(ThetaCommand obj){
         this.obj=obj;
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThetaConfigView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
