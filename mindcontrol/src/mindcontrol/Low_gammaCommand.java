 ...
 * @author siva
 */
public class Low_gammaCommand implements Command {
...
Low_gammaCommand(){
   ...
   return flag;
    ...
    public void setCmdconfig() {
        new Low_gammaConfigView().getConfig(this);
    }
    ...
    public void run(Trigger current) {
        ...
        while(!flag){
            try {
                low_gamma=EegMachine.low_gamma;
                //count clock if low_gamma is detected and clock not running
                if(operation.equals("greater than (>)") && low_gamma > Integer.parseInt(threshold)){detectflag=true;}
                else if(operation.equals("lesser than (<)") && low_gamma < Integer.parseInt(threshold)){detectflag=true;}
                else if(operation.equals("equals (=)") && low_gamma == Integer.parseInt(threshold)){detectflag=true;} 
