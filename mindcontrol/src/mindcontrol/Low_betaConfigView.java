 ...
 * @author siva
 */
public class Low_betaConfigView extends javax.swing.JFrame {

    /**
     * Creates new form MeditationConfigView
     */
    public Low_betaConfigView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Low_beta Command Configuration");

        jLabel2.setText("Enter the Threshold value of Low_beta: ");
...
//of obj is null remove creating object in getconfig. just make setvisible()
     ...
     */
     public void getConfig(Low_betaCommand obj){
         this.obj=obj;
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Low_betaConfigView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
