 ...
 * @author siva
 */
public class High_betaCommand implements Command {
...
High_betaCommand(){
   ...
   return flag;
    ...
    public void setCmdconfig() {
        new High_betaConfigView().getConfig(this);
    }
    ...
    public void run(Trigger current) {
        ...
        while(!flag){
            try {
                high_beta=EegMachine.high_beta;
                //count clock if high_beta is detected and clock not running
                if(operation.equals("greater than (>)") && high_beta > Integer.parseInt(threshold)){detectflag=true;}
                else if(operation.equals("lesser than (<)") && high_beta < Integer.parseInt(threshold)){detectflag=true;}
                else if(operation.equals("equals (=)") && high_beta == Integer.parseInt(threshold)){detectflag=true;} 
